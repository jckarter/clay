...
syn keyword clayKeyword public private import as record overloadable overload external static inlined lvalue rvalue enum var ref and or not if else goto return returnref while break continue for in returned lambda block try catch 
