...
syn keyword clayKeyword public private import as record overloadable overload external static inline callbyname lvalue rvalue enum var ref and or not if else goto return returnref while switch case default break continue for in try catch throw alias finally procedure
