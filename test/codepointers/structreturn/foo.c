...
Struct4  bar4 (Struct4  *r, int x)                  { *r = (Struct4 ){x};    }
Struct8  bar8 (Struct8  *r, Struct4  x, Struct4  y) { *r = (Struct8 ){x, y}; }
Struct16 bar16(Struct16 *r, Struct8  x, Struct8  y) { *r = (Struct16){x, y}; }
Struct32 bar32(Struct32 *r, Struct16 x, Struct16 y) { *r = (Struct32){x, y}; }
Struct64 bar64(Struct64 *r, Struct32 x, Struct32 y) { *r = (Struct64){x, y}; }
