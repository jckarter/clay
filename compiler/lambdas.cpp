    ...
    llvm::StringRef closureDataName, llvm::StringRef lname)
{
    ...
    OverloadPtr overload = new Overload(
        NULL, operator_expr_call(), code, false, IGNORE, STATUS_OVERRIDE, x->hasAsConversion
    );
    overload->env = env;
    ...
    llvm::StringRef lname)
{
    ...
    OverloadPtr overload = new Overload(NULL, procRef, code, false, IGNORE, STATUS_OVERRIDE, x->hasAsConversion);
    overload->env = env;
    overload->location = x->location;
