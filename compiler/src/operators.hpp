...
ObjectPtr operator_bitnot();
ObjectPtr operator_bitand();
ObjectPtr operator_bitor();
ObjectPtr operator_bitxor();
ObjectPtr operator_bitshl();
ObjectPtr operator_bitshr();
...
ObjectPtr operator_variantTag();
ObjectPtr operator_unsafeVariantIndex();
ObjectPtr operator_invalidVariant();
...
ExprPtr operator_expr_bitnot();
ExprPtr operator_expr_bitand();
ExprPtr operator_expr_bitor();
ExprPtr operator_expr_bitxor();
ExprPtr operator_expr_bitshl();
ExprPtr operator_expr_bitshr();
...
ExprPtr operator_expr_variantTag();
ExprPtr operator_expr_unsafeVariantIndex();
ExprPtr operator_expr_invalidVariant();
