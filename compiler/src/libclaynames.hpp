...
ObjectPtr prelude_bitand();
ObjectPtr prelude_bitor();
ObjectPtr prelude_bitnot();
ObjectPtr prelude_bitxor();
ObjectPtr prelude_bitshl();
ObjectPtr prelude_bitshr();
...
ExprPtr prelude_expr_bitand();
ExprPtr prelude_expr_bitor();
ExprPtr prelude_expr_bitnot();
ExprPtr prelude_expr_bitxor();
ExprPtr prelude_expr_bitshl();
ExprPtr prelude_expr_bitshr();
